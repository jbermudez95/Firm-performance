...
label var ihss_n_workers			   "Employment (# workers)"
label var final_input_costs 		   "Input costs (Millions Lempiras)"
label var final_log_input_costs 	   "Input costs (logs)" 
label var final_financial_costs 	   "Financial costs (Millions Lempiras)"
...
label var cit_total_assets             "Total assets (Millions Lempiras)"
